...
function initTowhub() {
  ...
  if ($(".testimonial-girl").length > 0) {
    var lsw = new Swiper(".testimonial-girl .swiper-container", {
      preloadImages: false,
      slidesPerView: 1,
      spaceBetween: 15,
      loop: true,
      ...
      navigation: {
        nextEl: ".listing-carousel-button-testi-next",
        prevEl: ".listing-carousel-button-testi-previous",
      },
      breakpoints: {
        1650: {
          slidesPerView: 1,
  ...
  if ($(".testimonilas-carousel-two").length > 0) {
    var j2 = new Swiper(".testimonilas-carousel-two .swiper-container", {
      preloadImages: false,
      slidesPerView: 3,
      spaceBetween: 20,
      loop: true,
  ...
  function mobMenuInit() {
    ...
    $(".main-menu nav:first-child").addClass("original");
    $(".menusb").menu();
