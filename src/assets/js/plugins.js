...
!(function (e) {
  e.fn.niceSelect = function (t) {
    ...
    function s(t) {
      console.log(t)
      let value = t[0].dataset.placeholder
      t.after(
        e("<div></div>")
          ...
          .html(
            t.attr("multiple")
              ? '<span class="multiple-options"></span><div class="nice-select-search-box"><input type="text" class="nice-select-search" placeholder="'+value+'"/></div><ul class="list"></ul>'
              : '<span class="current"></span><div class="nice-select-search-box"><input type="text" class="nice-select-search" placeholder="'+value+'"/></div><ul class="list"></ul>'
          )
      );
      var s = t.next(),
        l = t.find("option");
